...
import com.ryan.anmp_160420023_week4.databinding.StudentListItemBinding
import com.ryan.anmp_160420023_week4.model.Student
import com.ryan.anmp_160420023_week4.util.loadImage

class StudentListAdapter(val studentList:ArrayList<Student>): RecyclerView.Adapter<StudentListAdapter.StudentViewHolder>(), StudentListItemListener {
...
//        }
    ...
    override fun onButtonDetailClick(view: View) {
        val action = StudentListFragmentDirections.actionDetailStudent(view.tag.toString())
